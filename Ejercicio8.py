...
def countApplesAndOranges(s, t, a, b, apples, oranges):
    ...
    print('La cantidad de manzanas que caen en la casa de Sam son: '+str(resultado_manzanas))
    print('La cantidad de naranjas que caen en la casa de Sam son: '+str(resultado_naranjas))
...
manzanas = [-2, 2, 1]
naranjas= [5,-6]
countApplesAndOranges(punto_partida,punto_final,pos_manzano, pos_naranjo, manzanas, naranjas)
